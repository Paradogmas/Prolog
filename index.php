...
<div class="container" style="width: 400px;">
    <form action=" " method="POST">
        ...
        <p>Camp Ground <input type="checkbox" name="campground" value="campground(X, Y, true),"></p>
        <p>Hotel <input type="checkbox" name="hotel" value="hotel(X, Y),"></p>
        ...
        <p>Backpackers Destination <input type="checkbox" name="back_packers_destination" value="back_packers_destination(X, Y, true),"></p>
        <p>Budget Hotel Destination <input type="checkbox" name="budget_hotel_destination" value="budget_hotel_destination(X, Y, true),"></p>
        <p>Family Destination <input type="checkbox" name="family_destination" value="family_destination(X, Y, true),"></p>
        <p>Quiet Destination <input type="checkbox" name="quiet_destination" value="quiet_destination(X, Y, true),"></p>
        <p>Retiree Destination <input type="checkbox" name="retiree_destination" value="retiree_destination(X, Y, true),"></p>
        <p>National Park <input type="checkbox" name="national_park" value="national_park(X, Y, true),"></p>
