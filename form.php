                ...
                <div class="col fill_height">
                    ...
                    <div class="search_tabs_container">
                        <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                            <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start">new accommodation</div>
                    ...
                    <div class="search_panel active">
                        <form method="POST" action="" id="search_form" class="search_panel_content flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                            <fieldset>
                                <label style="font-size: 15px; font-weight: 700; color: #FFFFFF; text-transform: uppercase; margin-bottom: 14px;">accommodation name</label>
                                <input type="text-area" name="ac-name" required="true"><br>
                                <label style="font-size: 15px; font-weight: 700; color: #FFFFFF; text-transform: uppercase; margin-bottom: 14px;">accommodation city - country</label>
                                <input type="text-area" name="ac-city" required="true"><br>
                                <label style="font-size: 15px; font-weight: 700; color: #FFFFFF; text-transform: uppercase; margin-bottom: 14px;">accommodation contact</label>
                                <input type="text-area" name="ac-contact"><br>
                                <label style="font-size: 15px; font-weight: 700; color: #FFFFFF; text-transform: uppercase; margin-bottom: 14px;">accommodation image</label>
                                <input type="text-area" name="ac-image">
                            </fieldset>

                            <input value="Cadastrate" name="submit" type ="submit" class="button search_button"/><span></span><span></span><span></span><br>
                        </form>
                    </div>
                </div>
                <?php
                if($_POST['submit']):
                    require_once "new_accommodation.php";
                endif;
                ?>
            </div>
        </div>
