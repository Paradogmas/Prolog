...
if($_POST){
    ...
    exec('swipl -s Accommodation.pl -g "assert_one_s('."' ".$name." ',".$city.",".'false'.'), halt"', $output);
    exec('swipl -s Accommodation.pl -g "assert_two_s('."' ".$name." ',".$city.",".'false'.'), halt"', $output);
    exec('swipl -s Accommodation.pl -g "assert_three_s('."' ".$name." ',".$city.",".'true'.'), halt"', $output);
    exec('swipl -s Accommodation.pl -g "assert_bed_and_breakfast('."' ".$name." ',".$city.",".'false'.'), halt"', $output);
}
?>